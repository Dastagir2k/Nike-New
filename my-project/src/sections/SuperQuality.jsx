    ...
    >
      <div className="flex flex-1 flex-col">
        ...
        <h2 className="font-palanquin text-4xl capitalize font-bold lg:max-w-lg">
          We   Provide  You  <span className="text-coral-red ml-2">Super </span> 
<span className="text-coral-red  ml-2">
        ...
        <p className="mt-6 lg:max-w-lg">Our Dedication to detail and excelence ensures your satisfication</p>
        <div className="mt-11">
